      ...
      <div className="content__services">
        ...
        <div className="content__filter">
          ...
          <div className="content__filter-form">
            <input type="text" className="content__input" onChange={setFilter} />
            <button onClick={() => { }} className="content__filter-button">Сбросить</button>
          </div>
              ...
              return (
                <div className="content__card">
                  ...
                  <div className="content__card-wrapper">
                    ...
                    <button onClick={() => console.log(link)} className="content__card-button">Получить бонус</button>
                  </div>
                </div>
              )
            })
